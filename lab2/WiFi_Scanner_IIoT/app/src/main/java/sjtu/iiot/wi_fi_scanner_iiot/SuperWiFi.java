...
public class SuperWiFi extends MainActivity{
     ...
     * ***************************************************************************************************************/
    private String FileLabelName = "WifiSignalLog";// Define the file Name
    /*****************************************************************************************************************
     ...
     * ***************************************************************************************************************/
    private String FileNameGroup[] = {"TP-5G","Camelot","TP"};
    private ThreePointLocation locator=new ThreePointLocation();
    ...
    private void startScan()//The start of scanning
    {
        ...
        Thread scanThread = new Thread(new Runnable()
        {
            public void run() {
                ...
                double[] loc_point = locator.location(RSS_Value_Record[0]/ RSS_Measurement_Number_Record[0],RSS_Value_Record[1]/ RSS_Measurement_Number_Record[1],RSS_Value_Record[2]/ RSS_Measurement_Number_Record[2]);
                scanned.add("location: ["+loc_point[0]+","+loc_point[1]+"]\r\n");
                 //* ***************************************************************************************************************
